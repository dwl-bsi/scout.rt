...
describe('HtmlComponent', () => {
  ...
  describe('validateLayout', () => {
    ...
    it('does not layout components with an animating parent (JS)', async () => {
      let deferred = $.Deferred();
      let promise = deferred.promise();
      $comp.data('animate-promise', promise);
      promise.then(() => $comp.removeData('animate-promise'));
    ...
    it('does not layout animated components (JS)', async () => {
      let deferred = $.Deferred();
      let promise = deferred.promise();
      $comp.data('animate-promise', promise);
      promise.then(() => $comp.removeData('animate-promise'));
